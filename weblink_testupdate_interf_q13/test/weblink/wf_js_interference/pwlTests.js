/*------------------------------------------------------------------------
 ...
 08-Oct-24  Q-12-36  aphatak    $$12  Disabled window.* calls
 18-Apr-25  Q-13-04  aphatak    $$13  Updates for Edge browser
-------------------------------------------------------------------------*/
...
function pfcIsChrome()
{
   ...
   */
   ...
   if (window.top.hasOwnProperty("chrome") && !window.top.chrome.hasOwnProperty("webview"))
      return true;
   else
      return false;
}
...
function pfcCreate(className)
{
   ...
   if (pfcIsWindows())
      ...
      return window.top.chrome.webview.hostObjects.sync.JSCB.GetCustomization(className);
