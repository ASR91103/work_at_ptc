...
06-Dec-24   P-80-52   $$5  aphatak    Remove window funcs
*/
...
function listSheets()
{
  ...
  for (i = 1; i <= sheets; i++)
  {
    ...
    var output = "";
    output += "<h3>Sheet " + i + "</h3>";
    output += "<table>";
    output += " <tr><td> Width </td><td> " + info.Width + " </td></tr> ";
    output += "  <tr><td> Height </td><td> " + info.Height + " </td></tr> ";
    output += " <tr><td> Units </td><td> " + unit + " </td></tr> ";
    var formatName;
    if (format == void null)
      formatName = "none";
    else
    ...
    output += " <tr><td> Format </td><td> " + formatName + " </td></tr> ";
    output += "</table>";
    output += "<br>";
  }
...
function listViews() 
{
  ...
  for (i = 0; i < views.Count; i++)
  {
    ...
    output += "<h3>View " + viewName + "</h3>";
    output += "<table>";
    output += " <tr><td> Sheet </td><td> " + sheetNo + " </td></tr> ";
    output +=
      "  <tr><td> Model </td><td> " + descr.GetFullName() + " </td></tr> ";
    output += " <tr><td> Outline </td><td> ";
    output += "<table><tr><td> <i>Lower left:</i> </td><td>";
    output +=
        outline.Item(0).Item(0) + ", " +
        outline.Item(0).Item(1) + ", " +
        outline.Item(0).Item(2);

    output += "</td></tr><tr><td> <iUpper right:</i></td><td>";
    output +=
        outline.Item(1).Item(0) + ", " +
        outline.Item(1).Item(1) + ", " +
        outline.Item(1).Item(2);
    output += "</td></tr></table></td>";

    output += " <tr><td> Scale </td><td> " + scale + " </td></tr> ";
    output += " <tr><td> Display style </td><td> " + dispStyle + " </td></tr>";
    output += "</table>";
    output += "<br>";
  }
...
function lineEntityCreate()
{
  ...
  \*--------------------------------------------------------------------*/
  var instrs = pfcCreate("pfcDetailEntityInstructions").Create(geom, view);
